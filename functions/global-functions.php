...
function __autoload($class_name) {
	...
	$file = DOCUMENT_ROOT.'/Plataforma/_classes/class-MVC/class-'.$class_name.'.php';
	//$file = ABSPATH . '/classes/class-MVC/class-' . $class_name . '.php';

	if (!file_exists($file)) {
		$file = DOCUMENT_ROOT.'/Plataforma/_classes/class-Padrao/class-'.$class_name.'.php';
		//$file = ABSPATH . '/classes/class-Padrao/class-' . $class_name . '.php';
	}
...
function diepreprintr($x) {
	return die("<pre>".print_r($x, true)."</pre>");
}
function preprintr($x) {
